    ...
    public function create(): Response
    {
        return Inertia::render('webinars/Create', [
            ...
            'aiSourceUrls' => [
                ...
                'url' => null,
                'transcript' => null,
                'video_transcript_generate' => null,
                'file' => null,
                'bulk_delete' => null,
            ],
            'aiSources' => [],
    ...
    public function edit(Webinar $webinar): Response
    {
        ...
        return Inertia::render('webinars/Edit', [
            ...
            'aiSourceUrls' => [
                ...
                'video_transcript_generate' => route('admin.webinars.ai.sources.transcript.video', ['webinar' => $webinar->id]),
            ...
            'stats' => [
                ...
                'views_60_seconds' => $webinar->registrants()->where('max_watch_duration_seconds', '>=', 60)->count(),
                'views_watched_to_end' => $webinar->registrants()->where('has_watched_to_end', true)->count(),
